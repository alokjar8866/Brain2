    ...
    <nav className="fixed top-0 left-0 right-0 z-100 border-b border-white/6 backdrop-blur-xl bg-gray-800/80 px-[5vw] flex items-center justify-between h-16">
      ...
      <div className="flex gap-9 items-center">
        {["Features", "How it Works", "FAQ"].map(item => (
          <a key={item} href="#" className="text-[#9994b8] no-underline text-sm font-['Syne',sans-serif] font-medium tracking-[0.02em] transition-colors duration-200 hover:text-[#1a69fc]">{item}</a>
        ))}
